describe("ChemElements", function () {
	...
	var Elements, $httpBackend;
	
	beforeEach(inject(function (_ChemElements_, _$httpBackend_) {
		Elements = _ChemElements_;
		$httpBackend = _$httpBackend_;
	}));
	
	it("should contain all elements", function () {
		expect(Elements.H.symbol).toBeDefined();
		expect(Elements.H.name).toBeDefined();
		expect(Elements.H.weight).toBeDefined();
		expect(Elements.H.desc).toBeUndefined();
		expect(Elements.H.boilingPoint).toBeUndefined();
		expect(Elements.H.meltingPoint).toBeUndefined();
	});
	
	it("should get extended version of elements", function () {
		$httpBackend
			.expectGET("res/elements.json")
			.respond(elements);
		Elements.extended("res/elements.json");
		$httpBackend.flush();
		expect(Elements.H.desc).toBeDefined();
		expect(Elements.H.density).toBeDefined();
		expect(Elements.H.boilingPoint).toBeDefined();
		expect(Elements.H.meltingPoint).toBeDefined();
	})
	...
	it("should have 'unknown' property with invalid tokens", function () {
		var formulas = {
